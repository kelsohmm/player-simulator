...
class VmHost:
    ...
    def __init__(self, vm_name, snap_name, window_rect):
    ...
    def take_screen_shot(self):
        ...
        screen_array = display.take_screen_shot_to_array(self._ONLY_SCREEN_ID, screen_height, screen_width, self._BITMAP_FORMAT)
...
host = VmHost(VM_NAME, SNAP_NAME, (802, 607, 280, 31))
...
scipy.misc.imsave('outfile.jpg', png)
